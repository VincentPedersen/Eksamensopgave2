...
const executeSQL = (context,email,first_name,last_name,age,location,gender) => {
    var result = "";
    ...
    const request = new Request(`INSERT INTO [dating_app].[User] (email,first_name,last_name,age,location,gender_id) VALUES ('${email}','${first_name}','${last_name}','${age}','${location}','${gender}')`,function(err){
        if (err) {
...
module.exports = function (context, req) {
    ...
    executeSQL(context,email,first_name,last_name,age,location,gender)
}
